...
(function($) {
  ...
  Filestyle.prototype = {
    ...
    htmlInput : function() {
      if (this.options.input) {
        return '<input id="file_name" type="text" class="form-control ' + (this.options.size == 'nr' ? '' : 'form-control-' + this.options.size) + '" placeholder="'+ this.options.placeholder +'" disabled> ';
      } else {
        return '';
      }
    },
